...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | E27 - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for E27 - React.js Tailwind CSS Admin Dashboard Template"
      />
