...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | E27 - React.js Admin Dashboard Template"
        description="This is React.js Videos page for E27 - React.js Tailwind CSS Admin Dashboard Template"
      />
